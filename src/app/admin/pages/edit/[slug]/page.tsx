...
export default function EditPageAdmin() {
  ...
  const moveSection = (index: number, direction: -1 | 1) => {
    if (index + direction < 0 || index + direction >= formData.sections.length)
      return;
    const updated = [...formData.sections];
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const { id, createdAt, updatedAt, store, storeId, ...cleanPayload } =
        formData as any;
    ...
    <div className="p-6 max-w-5xl mx-auto space-y-6">
      ...
      <div className="flex justify-between items-center bg-white p-4 rounded-xl shadow-sm border border-gray-100 sticky top-0 z-10">
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-xl font-bold text-gray-900">
            {isNew ? "Create New Page" : `Editing: ${formData.title}`}
          </h1>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <div className="flex items-center">
              <span className="bg-gray-100 border border-gray-300 border-r-0 rounded-l-lg px-3 py-2 text-gray-500 text-sm">
                /
              </span>
              <input
                value={formData.slug}
      ...
      <div className="space-y-4">
        ...
        {formData.sections.map((section, index) => (
          <div
            key={index}
            className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden transition-all focus-within:ring-2 focus-within:ring-blue-500"
          >
            {/* Section Toolbar */}
            ...
            <div className="p-5 space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={(e) =>
                    updateSection(index, "contentHtml", e.target.value)
                  }
